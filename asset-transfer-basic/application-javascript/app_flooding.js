...
async function main() {
	try {
		...
		try {
			...
			console.log('\n--> Submit 1000 Transactions: CreateAsset, creates new asset with ID, color, owner, size, and appraisedValue arguments');
			var i;
			for (i = 0; i < 10; i++) {  				
				result = await contract.submitTransaction('CreateAsset', 'assetFlood-'+i+'', 'yellow', '5', 'Tom', '1300');
